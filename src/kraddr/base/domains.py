...
COMMON_MAP_FEATURE_COLUMNS: tuple[MapFeatureColumn, ...] = (
    ...
    MapFeatureColumn("road_name_code", False, "도로명코드"),
    MapFeatureColumn("road_name_address_code", False, "도로명주소관리번호"),
    MapFeatureColumn("building_management_number", False, "건물관리번호"),
